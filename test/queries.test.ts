...
it('can build for remote designer jobs', () => {
  const remoteDeigner = [
    {
      type: 'text',
      input: 'remote',
...
it('can build for remote marketing jobs from the past month', () => {
  const febQueryParts = [
    ...remoteMarketing,
    {
      type: 'last-month',
...
it('can all hr sites when not set', () => {
...
it('can get date variations from query', () => {
...
it('can make Google Search URL from query text', () => {
